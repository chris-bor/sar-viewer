...
#define MIN_RANGE   1e-1
#define MAX_RANGE   4e6
...
public:
  ...
  */
  ...
  enum CurveType {
      ctNoTypeSpecyfied     ///< No type specified
      ,ctMapCurve           ///< The map curve type fg. coast, road, river etc.
      ,ctPoints             ///< Points type fg. airports
      ,ctPolylines          ///< Polilines type fg. cities
      ,ctStripScan
  };
  ...
  void addData(double key, double value);
//  void addData(double t1, double key1, double value1, double t, double key2, double value2, uint nr_points);
...
public:
  ...
  */
  ...
  enum AspectRatio { atNone       ///< no aspect ratio
                     ,arX         ///< y aspest ratio is set depending on range x axis
                     ,arY         ///< x aspest ratio is set depending on range y axis
                   };
  Q_ENUMS(AspectRatio)
  ...
  */
  ...
  bool aspectRatio() const { return mAspectRatio; }
  ...
  void setAspectRatio(const bool val); // Sets value defines if keeping spect ratio is seted or not
...
public slots:
  ...
  void setScaleRatioSlot(const QCPRange &range);
